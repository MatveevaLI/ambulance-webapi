...
func (this *implAmbulanceWaitingListAPI) addRoutes(routerGroup *gin.RouterGroup) {
  ...
  routerGroup.Handle( http.MethodDelete, "/waiting-list/:ambulanceId/condition", this.DeleteWaitingListEntry)
  ...
  routerGroup.Handle( http.MethodPut, "/waiting-list/:ambulanceId/condition", this.UpdateWaitingListEntry)
}
