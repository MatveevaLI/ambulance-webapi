...
import (
	...
	"github.com/MatveevaLI/ambulance-webapi/internal/db_service"
...
// 	  }
// 	  ctx.Request = httptest.NewRequest("POST", "/medication/test-ambulance/entries", strings.NewReader(json))

// 	  sut := implMedicationListAPI{}
// 	  // ACT
// 	sut.UpdateMedicationListEntry(ctx)
// 	// ASSERT
...
func (suite *AmbulanceWlSuite) Test_UpdateWl_DbServiceUpdateCalled() {
	// ARRANGE
	suite.dbServiceMock.
		On("UpdateDocument", mock.Anything, "test-ambulance", mock.Anything).
		Return(nil)
